...
#define RX_FRONT_LEFT 3
#define RX_FRONT_RIGHT 2
#define RX_BACK_LEFT 1
#define RX_BACK_RIGHT 0

//!!PIPES ARE DIFFRENT PER TRANSMITTER
const uint64_t pipes[4] = {0xF0F0F0F0EALL, 0xF0F0F0F0FALL, 0xF0F0F0F0AALL, 0xF0F0F0F0CALL};
